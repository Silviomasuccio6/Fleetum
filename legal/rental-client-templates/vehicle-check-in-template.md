---
title: "Verbale Check-in Veicolo Template"
owner: "Fleetum"
version: "0.1.0-draft"
status: "draft"
...
# Verbale Check-in Veicolo Template
...
| Accessorio | Presente | Note |
|---|---|---|
| Chiavi | {{keys_delivered}} | {{keys_notes}} |
| Libretto | {{registration_document_delivered}} | {{registration_notes}} |
| Kit emergenza | {{emergency_kit_delivered}} | {{emergency_kit_notes}} |
