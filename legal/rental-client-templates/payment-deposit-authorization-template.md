---
title: "Autorizzazione Pagamento Cauzione e Addebiti Template"
owner: "Fleetum"
version: "0.1.0-draft"
status: "draft"
...
# Autorizzazione Pagamento Cauzione e Addebiti Template
...
Il cliente autorizza preautorizzazione, trattenute e addebiti successivi per causali documentate, inclusi danni, franchigie, ritardi, carburante, multe, pedaggi, ZTL e accessori mancanti.

| Causale | Importo | Documento prova | Metodo pagamento | Transaction ID |
|---|---:|---|---|---|
| {{charge_reason}} | {{charge_amount}} | {{evidence_document}} | {{payment_method}} | {{payment_transaction_id}} |
