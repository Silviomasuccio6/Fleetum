---
title: "Sinistro Furto Guasto Report Template"
owner: "Fleetum"
version: "0.1.0-draft"
status: "draft"
...
# Sinistro Furto Guasto Report Template
...
| Tipo | Data | Descrizione | Autorita/Officina | Foto | Testimoni | Stato |
|---|---|---|---|---|---|---|
| Sinistro | {{accident_date}} | {{accident_description}} | {{authority_or_workshop}} | {{photo_url}} | {{witnesses}} | {{case_status}} |
| Furto | {{theft_date}} | {{theft_description}} | {{authority_report}} | {{photo_url}} | - | {{case_status}} |
| Guasto | {{breakdown_date}} | {{breakdown_description}} | {{workshop_name}} | {{photo_url}} | - | {{case_status}} |
