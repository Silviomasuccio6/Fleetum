---
title: "Verbale Check-out Veicolo Template"
owner: "Fleetum"
version: "0.1.0-draft"
status: "draft"
...
# Verbale Check-out Veicolo Template
...
| Area | Stato uscita | Stato rientro | Differenza | Importo stimato |
|---|---|---|---|---:|
| Esterni | {{pickup_external_state}} | {{return_external_state}} | {{external_delta}} | {{external_estimated_amount}} |
| Interni | {{pickup_internal_state}} | {{return_internal_state}} | {{internal_delta}} | {{internal_estimated_amount}} |
| Carburante | {{pickup_fuel_level}} | {{return_fuel_level}} | {{fuel_delta}} | {{fuel_amount}} |
| Km | {{pickup_mileage}} | {{return_mileage}} | {{mileage_delta}} | {{extra_km_amount}} |
